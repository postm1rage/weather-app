...
const API_KEY = '68c333ede915b1a5fae67592eaa34272';
// Для удобства проверки ключ вставлен прямо в код
// В рабочей версии он должен храниться в отдельном конфигурационном файле
// и не попадать в репозиторий
